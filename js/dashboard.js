...
=======
  const accountsHTML = ST.settings.showAccountsSection===false ? '' : renderDashboardSection('contas','Contas Bancárias','(saldo independente das dívidas)',accountsBody,'grid-column:span 2');
...
=======
      invoiceHTML = renderDashboardSection('invoice','Próximo Vencimento de Fatura',`(${MONTHS[ST.vm]}/${ST.vy})`,invoiceBody,'grid-column:span 2');
>>>>>>> e89ab57f64bd391547ff47662a8ac2c7ac1cb16c
    }
  }

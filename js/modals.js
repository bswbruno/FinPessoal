...
function renderConfig(){
  ...
  <div class="settings-card" style="border:1px dashed var(--border)"><h3 style="color:var(--text3)">FinPessoal v9.3</h3><p style="font-size:12px;color:var(--text3);line-height:1.8">Sistema financeiro pessoal · Uso local neste navegador<br>Todos os dados ficam salvos apenas neste dispositivo<br>Sem servidor, sem internet obrigatória</p></div>`;
}
